...
Задача 0: Вернуть объект, содержащий массив key-value значений (key = string, value - frequency), отсортированные по значению.Функция countStrings(..) должна вернуть [b: 3, a: 2, c: 1]
	...
	Ответ:  yandex: Billy and Antony and Tom
     ...
     11) Вывести среднюю зарплату сотрудников
     12) Вывести имя сотрудника и его годовой оклад
     13) Вывести сотрудников со стажем работы более 10 лет и вывести в формате имя -> стаж работы
     14) Вывести сотрудников работавших на позиции dev более 1 раза
...
Больше практических заданий можно найти в этом курсе
https://stepik.org/course/1595/promo
